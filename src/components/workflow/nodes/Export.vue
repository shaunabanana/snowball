<template>
    <Node title="Export papers" output close
        :id="id"
        :loading="data.loading"
        :notes="data.notes"
        :inputs="[
            { id: 'papers', text: 'Papers to export', type: 'papers', class: 'data' },
            { id: 'selection', text: 'Selection: Only export specific papers', type: 'selection' },
        ]"
    >
